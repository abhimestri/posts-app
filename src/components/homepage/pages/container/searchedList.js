...
const SearchedListItem = (props) => {
  ...
  return (
    <ListItem className={classes.listItem}>
      ...
      <ListItemText style={{ width: "300px" }} primary={props.el.title} />
      <Box className={matches && classes.iconBox}>
        <IconButton
          edge="end"
          style={{ marginRight: "10px" }}
          aria-label="edit"
          onClick={() => props.likeEditHandlerSearch(props.el)}
        >
          {props.el.liked ? (
        ...
        <IconButton
          ...
          style={{ marginRight: "10px" }}
          aria-label="edit"
          onClick={() => props.dislikeEditHandlerSearch(props.el)}
        >
          {props.el.disliked ? (
